...
#ifndef MAPVIZ_PLUGINS_BESTGNSSPOS_PLUGIN_H_
#define MAPVIZ_PLUGINS_BESTGNSSPOS_PLUGIN_H_
...
#include "ui_bestgnsspos_config.h"



namespace mapviz_plugins
{
class BestgnssposPlugin : public mapviz_plugins::PointDrawingPlugin
{
  Q_OBJECT

public:
  BestgnssposPlugin();
  virtual ~BestgnssposPlugin();
...
private:
  ...
  void BestgnssposCallback(const novatel_gps_msgs::NovatelGNSSPositionPtr& bestgnsspos);
  void InspvaCallback(const novatel_gps_msgs::InspvaPtr& imu_inspva);
};
}

#endif  // MAPVIZ_PLUGINS_BESTGNSSPOS_PLUGIN_H_
